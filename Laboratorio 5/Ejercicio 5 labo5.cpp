/*Ejercicio 5: Crear un programa que solicite números al usuario, buscar los valores en un
árbol binario de búsqueda previamente construido, en caso que el valor
ingresado por el usuario se encuentre en el árbol binario, ingresarlo en una
lista simple enlazada, caso contrario, mostrar al usuario que el valor
ingresado no existe en el árbol. El programa dejará de solicitar números al
usuario hasta que ingrese -1, y mostrará el promedio de la lista enlazada
